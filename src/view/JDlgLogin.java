...
public class JDlgLogin extends javax.swing.JDialog {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(jTxtSenha, javax.swing.GroupLayout.PREFERRED_SIZE, 294, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jBtnEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnEntrarActionPerformed
        if (jTxtLogin.getText().equals("marcosBonitao") && jTxtSenha.getText().equals("logar")) {
            
            this.dispose();

            // Garante que a tela principal será tratada após o encerramento da tela de login
            SwingUtilities.invokeLater(() -> {
                JFrmMain mainFrame = new JFrmMain();
